        ...
        <>
            <div className="">
                ...
                <div className="w-[95%]  mx-auto max-w-[1000px] grid my-5 scroll-up py-10">
                    ...
                    <form onSubmit={(e) => {e.preventDefault(); alert("Booking Successful!");}} >
                        <div className="grid grid-cols-1 md:grid-cols-2 py-3">
                            <div className="grid grid-cols-1 py-4">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div>
                                        <input type="text" placeholder="First Name" className="border border-gray-200 p-2 rounded-lg w-[85%]" required/>
                                    </div>
                                    <div>
                                        <input type="text" placeholder="Last Name" className="border border-gray-200 p-2 rounded-lg w-[85%]" required/>
                                    </div>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 py-4">
                        ...
                        <div className="p-2">
                            ...
                            <div className="py-4 mx-auto">
                                <button type="submit" className="text-white bg-blue-500 text-lg p-4 px-10 cursor-pointer my-10 hover:bg-blue-700">Book Now</button>
                            </div>
                        </div>
                    </form>
                </div>
