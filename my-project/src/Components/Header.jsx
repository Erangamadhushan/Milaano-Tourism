        ...
        <>
            <div className="grid">
                ...
                <nav className="bg-bg-mainColor grid grid-cols-2 justify-between items-baseline space-x-5 p-5">
                    <div className="">
                        <h1 className="text-white font-bold text-2xl "><span className="text-orange-500">S</span>tart <span className="text-orange-500">T</span>o <span className="text-orange-500">F</span>inish</h1>
                    </div>
