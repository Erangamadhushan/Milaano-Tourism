    ...
    return (
        <>
            ...
            <div className=" py-5">
                ...
                <div>
                    <h4 className="text-[1.5em] font-semibold text-blue-500 text-center">------- Our Team -------</h4>
                    <h1 className="text-[2em] md:text-[2.5em]  text-center"> Explorer Our <span className="text-blue-500 fond-extrabold">STAFFS</span></h1>
