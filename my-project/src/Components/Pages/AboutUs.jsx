...
export default function AboutUs() {
    return (
        <>
            ...
            <div className=" py-5">
                <div className="p-5 w-[95%] max-w-[1000px] mx-auto flex justify-center items-center" data-aos="fade-up" data-aos-duration="600" data-aos-delay="200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 p-5 ">
                    <div className="min-h-[50vh] border border-1 p-3" data-aos="fade-up" data-aos-duration="600" data-aos-delay="300">
                        <h1 className="text-[3em] font-bold py-5 text-center">Our Vision</h1>
                    ...
                    <div className="min-h-[50vh] border border-1 p-3" data-aos="fade-up" data-aos-duration="600" data-aos-delay="300">
                        <h1 className="text-[3em] font-bold py-5 text-center">Our Mission</h1>
