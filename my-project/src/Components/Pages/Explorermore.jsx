  ...
  return (
    <div>
      <div className="w-[95%] mx-auto max-w-[1200px] my-10 scroll-up">
        <h3 className="py-3 text-[1.25em] md:text-[1.5em] text-center text-blue-500">Sri Lanka's luxury hotels blend traditional hospitality with modern extravagance to create memorable experiences for discerning guests. The island's rich culture and natural beauty provide a perfect backdrop for exceptional hotel services tailored to special customers.</h3>
      </div>
      <div className="w-[95%] flex flex-wrap justify-center items-baseline mx-auto max-w-[1400px] my-5">
            {
              explorerContent.items.map((item, index) => {
                return (
                  <>
                    <div className="w-[95%] max-w-[400px] min-h-[420px]  mx-5 my-5 p-5 border border-blue-200 rounded-lg shadow-md  scroll-up">
                      <h3 className="text-2xl text-center text-blue-500 font-bold">{item.title}</h3>
