...
function Findout() {
    ...
    return (
        <>
            ...
            <div className="w-[95%] max-w-[1200px] mx-auto p-5 py-10 my-5 shadow-md" id={destinationGuide.bestTime.title}>
                <h2 className="text-[2em] text-coral font-bold py-2">
            ...
            <div className="w-[95%] max-w-[1200px] mx-auto p-5 my-5 shadow-md" id={destinationGuide.mustVisitDestination.title}>
                <h2 className="text-[2em] font-bold text-coral py-2">
